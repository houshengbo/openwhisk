...
<<<<<<< HEAD:tests/src/test/scala/system/basic/WskUnicodePython2Tests.scala
...
>>>>>>> 7e0c0e9... Replace the test cases with REST implementation:tests/src/test/scala/system/basic/WskCliUnicodePython2Tests.scala
